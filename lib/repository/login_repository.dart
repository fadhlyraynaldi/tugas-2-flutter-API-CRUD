...
final response = await _dio.post('https://projectfirman.000webhostapp.com/serverforclient/logout.php', data: fdata,);
prefs.remove('session_token');
  ...
  Future Login({required String username, required String password}) async {
    ...
    final response = await _dio.post('https://projectfirman.000webhostapp.com/serverforclient/login.php',data: fdata,);
    log("res $response");
